...
var Employees = function () {
    ...
    DevAV.DBCustomFilterFields = [
        { name: "Employee_First_Name", publicName: "First Name" },
        { name: "Employee_Last_Name", publicName: "Last Name" },
        { name: "Employee_Birth_Date", publicName: "Birth Date", type: "date" },
        { name: "Employee_Hire_Date", publicName: "Hire Date", type: "date" },
        { name: "Employee_Title", publicName: "Title" },
        { name: "Employee_Mobile_Phone", publicName: "Mobile Phone" },
        { name: "Employee_Home_Phone", publicName: "Home Phone" }
    ];
