...
var Products = function () {
    ...
    DevAV.DBCustomFilterFields = [
        { name: "Product_Name", publicName: "Product Name" },
        { name: "Product_Category", publicName: "Category" },
        { name: "Product_Cost", publicName: "Cost", type: "number" },
        { name: "Product_Sale_Price", publicName: "Sale Price", type: "number" },
        { name: "Product_Retail_Price", publicName: "Retail Price", type: "number" },
        { name: "Product_Current_Inventory", publicName: "Inventory", type: "number" },
        { name: "Product_Manufacturing", publicName: "Manufacturing", type: "number" },
        { name: "Product_Backorder", publicName: "Backorders", type: "number" }
    ];
