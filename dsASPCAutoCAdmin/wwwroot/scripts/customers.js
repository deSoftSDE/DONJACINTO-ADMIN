...
var Customers = function () {
    ...
    DevAV.DBCustomFilterFields = [
        { name: "Customer_Name", publicName: "Name" },
        { name: "Customer_CIty", publicName: "City" },
        {
            name: "Customer_State",
            publicName: "State",
            type: "select",
        ...
        { name: "Customer_Zipcode", publicName: "Zipcode", type: "number" },
        { name: "Customer_Phone", publicName: "Phone" }
    ];
