...
var Tasks = function () {
    ...
    DevAV.DBCustomFilterFields = [
            { name: "Task_Subject", publicName: "Subject" },
            { name: "Task_Description", publicName: "Description" },
            { name: "Task_Start_Date", publicName: "Start Date", type: "date" },
            { name: "Task_Due_Date", publicName: "Due Date", type: "date" },
            { name: "Task_Status", publicName: "Status", type: "select", values: statuses },
            { name: "Task_Priority", publicName: "Priority", type: "select", values: priorities, options: { valueExpr: "id", displayExpr: "value" } },
            { name: "Task_Completion", publicName: "Completion", type: "number" }
    ];
